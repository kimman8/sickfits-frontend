...
export declare type Field<RootVal, Args extends Record<string, graphql.Arg<graphql.InputType>>, TType extends OutputType, Key extends string> = graphql.Field<RootVal, Args, TType, Key, Context>;
export declare type FieldResolver<RootVal, Args extends Record<string, graphql.Arg<graphql.InputType>>, TType extends OutputType> = graphql.FieldResolver<RootVal, Args, TType, Context>;
export declare type ObjectType<RootVal> = graphql.ObjectType<RootVal, Context>;
export declare type UnionType<RootVal> = graphql.UnionType<RootVal, Context>;
export declare type InterfaceType<RootVal, Fields extends Record<string, graphql.InterfaceField<Record<string, graphql.Arg<graphql.InputType>>, OutputType, Context>>> = graphql.InterfaceType<RootVal, Fields, Context>;
