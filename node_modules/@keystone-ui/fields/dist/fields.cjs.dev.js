...
const Calendar = _ref => {
  ...
  const augmentedModifiers = react.useMemo(() => _objectSpread(_objectSpread({}, modifiers), {}, {
    weekend: {
      daysOfWeek: [0, 6]
    }
  }), [modifiers]);
  return core.jsx("div", {
    css: styles
  }, core.jsx(DayPicker__default['default'], _extends({
...
const DatePicker = _ref => {
  ...
  }), formattedDate || 'dd/mm/yyyy'), core.jsx(popover.PopoverDialog, _extends({
    arrow: arrow,
    isVisible: isOpen,
    ref: dialog.ref
