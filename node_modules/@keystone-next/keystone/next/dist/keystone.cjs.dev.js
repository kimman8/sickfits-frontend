...
const withKeystone = (internalConfig = {}) => (phase, thing) => {
  if (phase === 'phase-production-build') {
    execa__default['default'].sync('node', [require.resolve('@keystone-next/keystone/bin/cli.js'), 'postinstall'], {
      stdio: 'inherit'
    });
  }
  ...
  internalConfigObj.webpack = (webpackConfig, options) => {
    if (options.isServer) {
      webpackConfig.externals = [...webpackConfig.externals, '@keystone-next/keystone/___internal-do-not-use-will-break-in-patch/api', '@keystone-next/keystone/___internal-do-not-use-will-break-in-patch/next-graphql', '@keystone-next/keystone/next', '@keystone-next/keystone/system', '.prisma/client'];
    }
