...
var SignoutButton = require('./SignoutButton-acdb1554.cjs.dev.js');
...
const NavItem = ({
  ...
  return core.jsx("li", null, core.jsx(adminUi_router_dist_keystone.Link, {
...
const AuthenticatedItemDialog = ({
  ...
  }, "Signed in as ", core.jsx("strong", null, item.label)) : core.jsx("div", {
    css: {
      fontSize: typography.fontSize.small
    }
  }, "GraphQL Playground and Docs"), core.jsx(popover.Popover, {
    placement: "bottom",
    triggerRenderer: ({
      triggerProps
